class shopItem{constructor(title,amount,short_description,link1,price1){this.title=title;this.amount=amount;this.short_description=short_description;this.link1=link1;this.price1=price1;this.linkToItem=title.toLowerCase().replace(" ","_")}}tabernas=new shopItem("TABERNAS HAT",4,"Regenerative materials","https://buy.stripe.com/7sI9Ci7cLbfX4ms7sD","┬ú2459");carnation=new shopItem("CARNATION HAT",3,"Regenerative materials","https://buy.stripe.com/aEU7ua7cLabT5qw6oA","┬ú2500");const shopItemList=[tabernas,carnation];let columnForShopItem="";for(let item of shopItemList){columnForShopItem+=`
