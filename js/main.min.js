document.onreadystatechange=function(){if(document.readyState!=="complete"){var loader=document.createElement("img");loader.id="loaderForSite";loader.classList="spinner-border";loader.src="favicon.ico";loader.style=`
    position: absolute;
    top: 0;
    bottom: 0;
    left: 0;
    ...
    `;document.getElementsByTagName("body").item(0).appendChild(loader);document.querySelector("#loaderForSite").style.visibility="visible";document.querySelector("body").style.visibility="hidden"}else{document.querySelector("body").style.visibility="visible";document.querySelector("#loaderForSite").style.visibility="hidden";document.getElementById("loaderForSite").remove()}};function loadScript(url){const script=document.createElement("script");script.src=url;document.head.appendChild(script)}var page=location.pathname.substring(location.pathname.lastIndexOf("/")+1);if(page.includes(".html")){page=page.replace(".html","")}const projects=["maison_0_x_lvmh","evasion","menigilda","caballo_andaluz","chelsea_fc_x_nike","soportujar","jaula_invisible","gallina_de_ciudad","overpopulated_world","la_veneno","franco's_exhumation","integrated_fight"];const magazines=["regenerative_folklore","fguk","hunter","malvie","office","sicky"];const homepage=["","index"];const shop=["","index","shop","tabernas_hat","carnation_hat","shop_item"];if(projects.indexOf(page)>=0){loadScript("./js/project.min.js")}else if(magazines.indexOf(page)>=0){loadScript("./js/magazine.min.js")}else if(homepage.indexOf(page)>=0){loadScript("./js/home.min.js");loadScript("./js/shop.min.js")}else if(shop.indexOf(page)>=0){loadScript("./js/shop.min.js")}function openNav(){document.getElementById("myNav").style.width="100%"}function closeNav(){document.getElementById("myNav").style.width="0%"}function openNav2(){document.getElementById("myNav2").style.width="100%"}function openNav3(){document.getElementById("myNav3").style.width="100%"}function closeNav2(){document.getElementById("myNav2").style.width="0%";document.getElementById("myNav").style.width="0%"}function closeNav3(){document.getElementById("myNav3").style.width="0%";document.getElementById("myNav").style.width="0%"}function backToNav(){document.getElementById("myNav2").style.width="0%"}function backToNav2(){document.getElementById("myNav3").style.width="0%"}let pageTitle=page.replace(/_/g," ");if(pageTitle.includes("maison")){pageTitle="maison/0 x lvmh"}else if(["regenerative_folklore","","index"].indexOf(page)>=0||magazines.indexOf(page)>=0){pageTitle=""}class Navbar extends HTMLElement{connectedCallback(){this.innerHTML=`
  ...
  <p class="d-lg-none mx-auto page-name my-auto">`+pageTitle+`</p>
...
<div id="cookieBanner" class="alert alert-light fade show fixed-bottom py-2 text-center" role="alert">
  ...
  <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
    ...
    `;document.querySelectorAll("a.nav-link").forEach(el=>{if(page==el.getAttribute("href")){el.classList.add("current")}});document.querySelectorAll("a.dropdown-item").forEach(el=>{if(page==el.getAttribute("href")){el.classList.add("current")}});document.querySelectorAll(".overlay-content a").forEach(el=>{if(page==el.getAttribute("href")){el.classList.add("current")}})}}marqueeContent=`<li><p class="text-center gradient"><span>Featured in:</span></p></li>
...
<li><a href="https://talkingtextilesmag.com/silvia-acien" target="_blank"><img  height="35" src="images/magazines/talking_textiles.png"></a></li>
 <li><a href="office"><img class="featured-logo" src="images/magazines/office.png"></a></li>
   ...
   <li><img height="36" src="images/awards/framework_knitters.png" title="Framework Knitters"></li>`;class Footer extends HTMLElement{connectedCallback(){this.innerHTML=`
  ...
  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<img height="24" src="images/lad8s_logo.png"> developed</a>
    ...
    `}}class CommonHead extends HTMLElement{connectedCallback(){var pageTitleHead;if(["fguk","hunter","malvie","office","sicky"].indexOf(page)>=0){pageTitleHead="ACIEN x "+page.toUpperCase()}else if(["index",""].indexOf(page)>=0){pageTitleHead="ACIEN"}else if(["maison_0_x_lvmh"].indexOf(page)>=0){pageTitleHead="Maison/0 x LVMH - ACIEN"}else{pageTitleHead=(page.charAt(0).toUpperCase()+page.slice(1)+" - ACIEN").replace(/_/g," ")}document.head.innerHTML=document.head.innerHTML+`<title>`+pageTitleHead+`</title>`;document.head.innerHTML=document.head.innerHTML+`
    <link rel="icon" type="image/x-icon" href="favicon.ico">
  <!-- CSS only -->
<meta name="viewport" content="width=device-width, initial-scale=1">
    `;function includeFA(file){var script=document.createElement("script");script.src=file;script.type="text/javascript";script.crossorigin="anonymous";document.getElementsByTagName("head").item(0).appendChild(script)}function includeBootstrapJS(file){var script=document.createElement("script");script.src=file;document.getElementsByTagName("head").item(0).appendChild(script)}function includeGoogleTag(file){var script=document.createElement("script");script.async=true;script.src=file;document.getElementsByTagName("head").item(0).appendChild(script)}function includeMain(filename){var fileref=document.createElement("link");fileref.setAttribute("rel","stylesheet");fileref.setAttribute("type","text/css");fileref.setAttribute("href",filename);document.getElementsByTagName("head").item(0).appendChild(fileref)}function includeBootsrapCSS(filename){var fileref=document.createElement("link");fileref.setAttribute("rel","stylesheet");fileref.setAttribute("type","text/css");fileref.setAttribute("href",filename);document.getElementsByTagName("head").item(0).appendChild(fileref)}includeFA("https://kit.fontawesome.com/581d00b336.js");includeBootstrapJS("js/bootstrap/bootstrap.bundle.min.js");includeBootsrapCSS("css/bootstrap/bootstrap.min.css");includeMain("css/main.css");includeGoogleTag("https://www.googletagmanager.com/gtag/js?id=G-0M4GEK1QY7")}}customElements.define("app-head",CommonHead);customElements.define("app-footer",Footer);customElements.define("app-navbar",Navbar);window.dataLayer=window.dataLayer||[];function gtag(){dataLayer.push(arguments)}gtag("js",new Date);gtag("config","G-0M4GEK1QY7");document.addEventListener("DOMContentLoaded",function(){if(localStorage.getItem("cookieBannerConfirmed")){document.getElementById("cookieBanner").style.display="none"}document.getElementById("confirmButton").addEventListener("click",function(){localStorage.setItem("cookieBannerConfirmed","true");document.getElementById("cookieBanner").style.display="none"})});
